...
class MobileViT(nn.Module):
    ...
    """
    def __init__(self, model_cfg: Dict, in_channels=5,  num_classes: int = 1000):
        super().__init__()
...
def mobile_vit_xx_small(in_channels=5,num_classes: int = 1000):
    ...
    m = MobileViT(config, in_channels=in_channels, num_classes=num_classes)
    return m
